...
> Marvell 是當前 AI 基礎設施浪潮中最具結構性確定性的半導體公司之一，但它不是「AI 概念股」，而是有實質訂單、長週期設計合約支撐的核心受益者。Forward P/E 16x 對應 FY2027 EPS 成長 77% 的組合極為罕見——在 AI 基礎設施支出維持強勁的基準情境下，此估值具有顯著吸引力。
>
> 核心買入邏輯：**FY2027 Design Win 開始大規模量產 → 營收加速 → EPS 槓桿效應 → 估值重估。** 分析師目標均價 $120.28 隱含約 37% 上漲空間，且 40 位分析師追蹤是極高覆蓋率的成熟標的，資訊透明度高。
>
> **值得深入追蹤。** 當前股價 $87.86 距離分析師共識目標仍有約 37% 安全邊際。主要需監控的是 Q1 FY2027 財報（2026 年 5–6 月）能否確認 Design Win 量產加速的時間線。
...
| 日期 | 事件 |
|------|------|
| 2026-03-16 前後 | **Evercore 升評**：理由為「強勁指引為核心推動力」，明確肯定 FY2027 成長能見度，分析師目標上調至 $120.28 |
| 2026-03-16 前後 | **Mojo Vision 微LED光互連長期合作**：Marvell 作為主要投資方達成長期合作，共同開發 micro-LED 光互連方案用於 AI 資料中心頻寬瓶頸，直接強化光互連 DSP 業務護城河敘事 |
| 2026-03-16 起 | **Nvidia GTC 2026 登場**：Jensen Huang 主題演講將確認 GB300/Blackwell Ultra 量產時程，為 MRVL AI ASIC 供應鏈需求最直接的近期驗證催化劑 |
| 待觀察 | Q1 FY2027 財報（約 2026-05/06）：確認 Design Win 量產進度及 FY2027 全年指引 |
...
- **優先級：** **1**（最高）
- **建議進場條件：**
  - **技術面：** ✅ 股價已突破並站穩 $80（前波壓力位）——2026-03-16 現價 $87.86 確認此條件達成；或回測 $85–$88 支撐區後企穩，提供補倉點
