...
| **毛利率趨勢** | 產品組合升級程度 | 50.7%（Non-GAAP 接近 60%），逐年改善 |
...
| **預期 EPS（FY2027 Non-GAAP）** | $4.72 | YoY +71% |
| **毛利率（GAAP）** | 50.7% | Non-GAAP ~60% |
| **營業利益率（GAAP）** | 17.7% | Non-GAAP ~35% |
| **Trailing P/E** | 27.52x | 基於 GAAP EPS |
| **Forward P/E** | 16.03x | 基於 FY2027 Non-GAAP EPS |
| **P/B** | 4.57x | |
| **P/S（FY2027E）** | ~6.0x | 基於 ~$11B 營收指引 |
| **分析師目標均價** | $114.06 | 追蹤分析師 39 人 |
| **隱含上漲空間** | +50.7% | 相對現價 $75.68 |

**估值評析：**  
Forward P/E 16x 對一家 AI ASIC 核心受益公司而言明顯低估——同業 Broadcom 目前交易在 25–28x Forward P/E。若以 Broadcom 倍數套用，Marvell 合理股價區間為 $100–$120，與分析師共識目標價吻合。EPS 成長率 71%（FY2027E）對應 16x PE 的 PEG 僅 0.23，具有顯著安全邊際。
...
| 指標 | 數值 |
|------|------|
| 本益比（Trailing P/E） | 26.66 |
| 預期本益比（Forward P/E） | 16.84 |
| EPS（TTM） | 3.36 USD |
| 預期 EPS | 5.32 USD |
| 股價淨值比（P/B） | 5.31 |
| 毛利率 | 51.7% |
...
> Marvell 是當前 AI 基礎設施浪潮中最具結構性確定性的半導體公司之一，但它不是「AI 概念股」，而是有實質訂單、長週期設計合約支撐的核心受益者。Forward P/E 16x 對應 FY2027 EPS 成長 71% 的組合極為罕見——在 AI 基礎設施支出維持強勁的基準情境下，此估值具有顯著吸引力。
>
> 核心買入邏輯：**FY2027 Design Win 開始大規模量產 → 營收加速 → EPS 槓桿效應 → 估值重估。** 分析師目標均價 $114 隱含 51% 上漲空間，且 39 位分析師追蹤是極高覆蓋率的成熟標的，資訊透明度高。
>
> **值得深入追蹤。** 當前股價 $75.68 距離分析師共識目標有足夠安全邊際。主要需監控的是 Q1 FY2027 財報（2026 年 5–6 月）能否確認 Design Win 量產加速的時間線。
...
- **優先級：** **1**（最高）
- **建議進場條件：**
  - **技術面：** 股價突破並站穩 $80（前波壓力位），成交量放大確認；或回測 $68–$70（50MA 支撐區）後企穩，提供更佳風險報酬入場點
  - **基本面觸發：** Q1 FY2027 財報（預計 2026 年 5–6 月）確認資料中心營收持續佔比提升、Design Win 管線無縮減，且 FY2027 全年指引維持或上調至 $11B+
  - **宏觀確認：** Hyperscaler（Google / Amazon）資本支出指引無下修，AI 基礎設施支出週期延伸信號
  - **停損參考：** 若股價跌破 $65（技術破位），或管理層出現 Design Win 流失、大客戶訂單縮減等基本面惡化信號，重新評估論點
